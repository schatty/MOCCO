...
def run(args):
    ...
    if args.algo == "SAC":
        ...
        algo = TD3(
            ...
            tanh_exploration_arg=args.tanh_exploration_arg,
            tanh_q_arg=args.tanh_q_arg,
            wandb=wandb
        )
    elif args.algo == "DDPG":
        algo = DDPG(
...
if __name__ == '__main__':
    ...
    p.add_argument("--tanh_exploration_arg", type=float, default=1000)
    p.add_argument("--tanh_q_arg", type=float, default=1)
    args = p.parse_args()
    run(args)
